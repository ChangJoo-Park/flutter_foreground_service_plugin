...
public class FlutterForegroundPlugin implements MethodCallHandler {
    ...
    public void onMethodCall(MethodCall call, Result result) {
        switch (call.method) {
            case "startForegroundService":
                ...
                launchForegroundService(icon, color, title, content, subtext, chronometer);
    ...
    private void launchForegroundService(String icon, int color, String title, String content, String subtext, Boolean chronometer) {
